...
<section class="playlist-videos">
   ...
   <div class="box-container">
      ...
      <a class="box" href="watch-video.jsp">
         <i class="fas fa-play"></i>
         <img src="resources/images/post-1-1.png" alt="">
         <h3>complete HTML tutorial (part 01)</h3>
      </a>

      <a class="box" href="watch-video.jsp">
         <i class="fas fa-play"></i>
         <img src="resources/images/post-1-2.png" alt="">
         <h3>complete HTML tutorial (part 02)</h3>
      </a>

      <a class="box" href="watch-video.jsp">
         <i class="fas fa-play"></i>
         <img src="resources/images/post-1-3.png" alt="">
         <h3>complete HTML tutorial (part 03)</h3>
      </a>

      <a class="box" href="watch-video.jsp">
         <i class="fas fa-play"></i>
         <img src="resources/images/post-1-4.png" alt="">
         <h3>complete HTML tutorial (part 04)</h3>
      </a>

      <a class="box" href="watch-video.jsp">
         <i class="fas fa-play"></i>
         <img src="resources/images/post-1-5.png" alt="">
         <h3>complete HTML tutorial (part 05)</h3>
      </a>

      <a class="box" href="watch-video.jsp">
         <i class="fas fa-play"></i>
         <img src="resources/images/post-1-6.png" alt="">
